...
if("FALSE" STREQUAL "TRUE")
  set(spinnaker_sdk_camera_driver_SOURCE_PREFIX /home/auv/spinnaker_sdk_camera_driver)
  set(spinnaker_sdk_camera_driver_DEVEL_PREFIX /home/auv/spinnaker_sdk_camera_driver/cmake-build-debug/devel)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spinnaker_sdk_camera_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
